	...
	function Le(n, o, i) {
		...
		(i = void 0 === i ? {} : i),
			"function" == typeof e.CustomEvent
				...
				: (r = t.createEvent("CustomEvent")).initCustomEvent(
						o,
						!0,
						!0,
						i
	...
	return (
		...
		function (P, F) {
			...
			if (!Q(K("html"), a)) {
				...
				var Fe,
					...
					Je = {
						...
						touchstart:
							"ontouchstart" in e ? "touchstart" : $e.down,
					},
					Ze =
			...
			function mt(e) {
				e
					...
					: (ht(!1),
						(Be || ze) &&
							(F.autoScrolling &&
								(se.removeEventListener(Je.touchmove, jt, {
									passive: !1,
								}),
								se.removeEventListener(Je.touchmove, Nt, {
									passive: !1,
			...
			function Ct(e, n, o) {
				...
				var f = K(O, e)[0];
				null != f &&
				(0 !== ie(K(g), h) || (0 === ie(K(g), h) && 0 !== ie(f)))
					? In(f, "internal")
					: ce(n[0], c);
			}
			function Ht(e, t) {
				return (
					F.navigationTooltips[e] || F.anchors[e] || t + " " + (e + 1)
				);
			}
			function It() {
				var e,
				...
				if (Pt(t)) {
					...
					(rt = o.y),
						...
						K(H, n).length && Math.abs(it - lt) > Math.abs(ot - rt)
							? !Re &&
								Math.abs(it - lt) >
									(e.innerWidth / 100) * F.touchSensitivity &&
								(it > lt
									? Ue.m.right && Lt(n)
									: Ue.m.left && xt(n))
							: F.autoScrolling &&
				...
				if (null != e) {
					...
					if (
						...
						if (
							(null != v.activeSlide &&
								((f =
									v.activeSlide.getAttribute("data-anchor")),
								(d = ie(v.activeSlide))),
						...
						F.autoScrolling &&
							...
							$t(e),
							F.scrollOverflow &&
								F.scrollOverflowHandler.onLeave(),
			...
			function Jt(e) {
				...
				K("video, audio", t).forEach(function (e) {
					...
					K('iframe[src*="youtube.com/embed/"]', t).forEach(
						function (e) {
			...
			function sn(e) {
				2 == e.which &&
					((ct = e.pageY), Ne.addEventListener("mousemove", dn));
			}
			function cn(e) {
						...
						: (ce(t, c),
							...
							(function (e, t, n) {
								...
								if (F.css3) {
									...
									(de.test.left[t.sectionIndex] = Math.round(
										o.left
									)),
										Pn(
											e,
			...
			function mn(e) {
				...
				return (
					ue(e, r), $(e, { "-webkit-transition": t, transition: t })
				);
			}
			function Sn(e) {
				return ce(e, r);
